...
function decodeAudioData(data, ctx, sampleRate, numChannels) {
    return __awaiter(this, void 0, void 0, function () {
        var dataInt16, frameCount, buffer, channel, channelData, i;
        return __generator(this, function (_a) {
            dataInt16 = new Int16Array(data.buffer);
            frameCount = dataInt16.length / numChannels;
            buffer = ctx.createBuffer(numChannels, frameCount, sampleRate);
