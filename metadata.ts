import { User, UserRole, Claim, ClaimStatus, ClaimType, Appointment, SubscriptionPlan, ProgressNote, Prescription, Message, BillingInvoice, LabOrder, Referral, ReferralStatus, SystemAuditLog } from './types';
...
export const MOCK_USERS: User[] = [
  ...
  { id: 'adm1', name: 'Rish Novo', email: 'rishnovo@gmail.com', password: 'Rish@novo1', role: UserRole.ADMIN, avatarUrl: 'https://i.pravatar.cc/150?u=adm1', phone: '555-555-1212', status: 'Active', createdAt: '2023-09-01T10:00:00Z' },
...
export const MOCK_AUDIT_LOG: SystemAuditLog[] = [
    ...
    // FIX: Changed string literal 'PATIENT' to enum member UserRole.PATIENT for type correctness.
